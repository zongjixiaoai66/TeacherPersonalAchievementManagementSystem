 ...
 */
@TableName("luenwen")
public class LuenwenView extends LuenwenEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 论文类型的值
		*/
		private String luenwenValue;
	...
	public LuenwenView(LuenwenEntity luenwenEntity) {
		try {
			BeanUtils.copyProperties(this, luenwenEntity);
			...
			* 获取： 论文类型的值
			*/
			public String getLuenwenValue() {
				return luenwenValue;
			}
			/**
			* 设置： 论文类型的值
			*/
			public void setLuenwenValue(String luenwenValue) {
				this.luenwenValue = luenwenValue;
			}
