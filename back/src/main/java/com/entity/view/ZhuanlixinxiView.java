...
public class ZhuanlixinxiView extends ZhuanlixinxiEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 专利类型的值
		*/
		private String zhuanlixinxiValue;
	...
	public ZhuanlixinxiView(ZhuanlixinxiEntity zhuanlixinxiEntity) {
		try {
			...
			* 获取： 专利类型的值
			*/
			public String getZhuanlixinxiValue() {
				return zhuanlixinxiValue;
			}
			/**
			* 设置： 专利类型的值
			*/
			public void setZhuanlixinxiValue(String zhuanlixinxiValue) {
				this.zhuanlixinxiValue = zhuanlixinxiValue;
			}
