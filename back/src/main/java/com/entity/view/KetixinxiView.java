...
public class KetixinxiView extends KetixinxiEntity implements Serializable {
	...
	public KetixinxiView(KetixinxiEntity ketixinxiEntity) {
		try {
			...
			* 获取： 课题类型的值
			*/
			public String getKetixinxiValue() {
				return ketixinxiValue;
			}
			/**
			* 设置： 课题类型的值
			*/
			public void setKetixinxiValue(String ketixinxiValue) {
				this.ketixinxiValue = ketixinxiValue;
			}
