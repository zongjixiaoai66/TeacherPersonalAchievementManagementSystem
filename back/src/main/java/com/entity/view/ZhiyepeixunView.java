...
public class ZhiyepeixunView extends ZhiyepeixunEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 荣誉类型的值
		*/
		private String zhiyepeixunValue;
	...
	public ZhiyepeixunView() {

	}

	public ZhiyepeixunView(ZhiyepeixunEntity zhiyepeixunEntity) {
		try {
			BeanUtils.copyProperties(this, zhiyepeixunEntity);
			...
			* 获取： 荣誉类型的值
			*/
			public String getZhiyepeixunValue() {
				return zhiyepeixunValue;
			}
			/**
			* 设置： 荣誉类型的值
			*/
			public void setZhiyepeixunValue(String zhiyepeixunValue) {
				this.zhiyepeixunValue = zhiyepeixunValue;
			}
