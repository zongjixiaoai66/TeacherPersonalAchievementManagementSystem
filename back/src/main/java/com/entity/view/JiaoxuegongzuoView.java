...
public class JiaoxuegongzuoView extends JiaoxuegongzuoEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 工作类型的值
		*/
		private String jiaoxuegongzuoValue;
	...
	public JiaoxuegongzuoView() {

	}

	public JiaoxuegongzuoView(JiaoxuegongzuoEntity jiaoxuegongzuoEntity) {
		try {
			BeanUtils.copyProperties(this, jiaoxuegongzuoEntity);
			...
			* 获取： 工作类型的值
			*/
			public String getJiaoxuegongzuoValue() {
				return jiaoxuegongzuoValue;
			}
			/**
			* 设置： 工作类型的值
			*/
			public void setJiaoxuegongzuoValue(String jiaoxuegongzuoValue) {
				this.jiaoxuegongzuoValue = jiaoxuegongzuoValue;
			}
