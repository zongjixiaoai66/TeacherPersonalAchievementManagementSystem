...
//                            yonghuEntity.setYonghuName(data.get(0));                    //教师姓名 要改的
...
//                            yonghuEntity.setYonghuZc(data.get(0));                    //职称 要改的
//                            yonghuEntity.setYonghuZy(data.get(0));                    //学历 要改的
//                            yonghuEntity.setYonghuXy(data.get(0));                    //从事专业 要改的
//                            yonghuEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            yonghuEntity.setXibuTypes(Integer.valueOf(data.get(0)));   //系部 要改的
//                            yonghuEntity.setYonghuTime(sdf.parse(data.get(0)));          //出身日期 要改的
...
//                            yonghuEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "教师");
        R r = R.ok();
        r.put("token", token);
        r.put("role","教师");
