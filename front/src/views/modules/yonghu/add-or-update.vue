    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教师姓名" prop="yonghuName">
                       <el-input v-model="ruleForm.yonghuName"
                                 placeholder="教师姓名" clearable  :readonly="ro.yonghuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="职称" prop="yonghuZc">
                       <el-input v-model="ruleForm.yonghuZc"
                                 placeholder="职称" clearable  :readonly="ro.yonghuZc"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="职称" prop="yonghuZc">
                           <el-input v-model="ruleForm.yonghuZc"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学历" prop="yonghuZy">
                       <el-input v-model="ruleForm.yonghuZy"
                                 placeholder="学历" clearable  :readonly="ro.yonghuZy"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="学历" prop="yonghuZy">
                           <el-input v-model="ruleForm.yonghuZy"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="从事专业" prop="yonghuXy">
                       <el-input v-model="ruleForm.yonghuXy"
                                 placeholder="从事专业" clearable  :readonly="ro.yonghuXy"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="从事专业" prop="yonghuXy">
                           <el-input v-model="ruleForm.yonghuXy"
                                     placeholder="从事专业" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="系部" prop="xibuTypes">
                        <el-select v-model="ruleForm.xibuTypes" :disabled="ro.xibuTypes" placeholder="请选择系部">
                            <el-option
                                v-for="(item,index) in xibuTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="系部" prop="xibuValue">
                        <el-input v-model="ruleForm.xibuValue"
                            placeholder="系部" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="出身日期" prop="yonghuTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yonghuTime" label="出身日期" prop="yonghuTime">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuTime: [
                              { required: true, message: '出身日期不能为空', trigger: 'blur' },
                          ],
                   yonghuDelete: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xibu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xibuTypesOptions = data.data.list;
                    }
                });
